...
function salvarEmArquivoJSON() {
    ...
    for (const [url, { html, links }] of Object.entries(paginasArmazenadas)) {
        ...
        estruturaFormatada.paginas_music.push({
            Página: url,
    ...
    fs.writeFileSync('paginas_music.json', JSON.stringify(estruturaFormatada, null, 2), 'utf-8');
    console.log('\u2705 Dados salvos no arquivo paginas_music.json');
}
...
// Exemplo de uso:
const urlInicial = 'https://anacadad.github.io/paginas-html/rock.html';
